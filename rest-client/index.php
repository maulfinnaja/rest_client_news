...
$api_key="ed0806f50f72494b8f26da6fdc6d5517";
...
<?php foreach ($hasil['articles'] as $row) { ?>
    ...
    <div class="card h-100 shadow-sm">
      <img src="<?php echo $row['urlToImage']; ?>" class="card-img-top" height="180px" style="object-fit: cover;">
      <div class="card-body">
        <h6 class="card-title"><?php echo $row['title']; ?></h6>
        <p class="card-text text-muted"><i>Oleh <?php echo $row['author']; ?></i></p>
        <a href="<?php echo $row['url']; ?>" class="btn btn-info btn-sm" target="_blank">Selengkapnya</a>
      </div>
    </div>
  </div>
